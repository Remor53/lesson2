...
for class_index in class_list:
    ...
    score_summ += score_in_class_summ
    student_number += student_in_class_number
    print('В классе ' + class_index['school_class'] + ' средний балл - ' + str(float('{0:.2f}'.format(score_in_class_summ / student_in_class_number))))
    score_in_class_summ = 0
    student_in_class_number = 0
print('Средний балл по школе - ' + str(float('{0:.2f}'.format(score_summ / student_number))))